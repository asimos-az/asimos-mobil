  ...
  private fun getExpoGradlePluginsFile(settings: Settings): File {
    val expoModulesAutolinkingPath =
      settings.providers.exec { env ->
        val nodeExecutable = System.getenv("NODE_BINARY") ?: (if (java.io.File("${System.getProperty("user.home")}/.nvm/versions/node/v20.20.1/bin/node").exists()) "${System.getProperty("user.home")}/.nvm/versions/node/v20.20.1/bin/node" else "node")
