...
import { styles } from "./EmployerProfileScreen.styles";
      ...
      <SafeScreen style={styles.safeArea}>
        <View style={styles.guestWrap}>
          <View style={styles.guestIcon}>
            <Ionicons name="briefcase" size={32} color="#CBD5E1" />
          </View>
          <Text style={styles.guestTitle}>HR Profilinə Giriş</Text>
          <Text style={styles.guestSub}>
            Elanları və bildirişləri görmək üçün hesaba daxil olun.
          </Text>
